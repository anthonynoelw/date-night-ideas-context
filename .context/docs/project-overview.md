...
* Server (Laravel 11): Acts as the central orchestrator. It validates requests, fetches external weather data, manages user quotas (Stripe-integrated), and constructs prompts for the LLM.
